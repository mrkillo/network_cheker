/**
 * @file dropDown_sprayMethod_gen.c
...
#include "dropDown_sprayMethod_gen.h"
#include "ALA_Feeder.h"
...
lv_obj_t * dropDown_sprayMethod_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_name_static(lv_slider_0, "dropDown_sprayMethod_#");
